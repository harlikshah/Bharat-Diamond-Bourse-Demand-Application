...
<h4><b>FILTER & Sort by category</b></h4>
 <form  method="post" action="Newsfeeds.php?go"  id="searchform"> 
  <table>
  <tr>
  ...
  { 
   ...
   { 
     ...
     //-query  the database table 
        $sql="SELECT * FROM newsfeed WHERE shape ='$_POST[sname]' AND  colorscale = '$_POST[colorname]' AND  clarityscale = '$_POST[clarityname]' AND  Certify = '$_POST[certifyname]' AND  fl = '$_POST[flname]' AND  bs = '$_POST[bsname]'"; 
...
<center>
  ...
  $strSQL = "SELECT * FROM newsfeed order by id desc";
